...
module.exports = (function() {
    ...
    api.verify = function(text, config, saveState) {
        ...
        if (!parseError) {
            ...
            controller = new esdispatch.ESDispatcher();
            ...
            Object.keys(config.rules).filter(function(key) {
                ...
                if (ruleCreator) {
                    ...
                    Object.keys(rule).forEach(function(selector) {
                        controller.on((selector.slice(-6) === ":after" ? selector = selector.slice(0, -6) : selector), function(_, node, ancestry){
                            controller.parents = function(){ return ancestry; }; /* gross */
                            controller.current = function(){ return node; }; /* gross */
                            rule[selector](node);
                        });
                    });
                } else {
             ...
             */
            controller.root = ast; /* gross */
            controller.observe(ast);
